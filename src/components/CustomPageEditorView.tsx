...
3. नवग्रह मंडल एवं सर्वतोभद्र मंडल निर्माण`,
  ...
  {
    name: 'शिमला सिद्ध मंदिर व तीर्थ माहात्म्य',
    category: 'शिमला तीर्थ',
    description: 'जाखू हनुमान, तारा देवी, संकट मोचन, काली बाड़ी व भीमाकाली मंदिर',
    content: `## 🏔️ शिमला के पावन सिद्ध पीठ एवं आध्यात्मिक ऊर्जा केंद्र
...
const DEFAULT_PAGES: CustomPage[] = [
  ...
  {
    id: 'shimla-teerth',
    title: 'शिमला सिद्ध मंदिर व तीर्थ माहात्म्य',
    category: 'शिमला तीर्थ',
